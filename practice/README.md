...
**Краткое описание:** Система автоматического обнаружения лесных пожаров в реальном времени с использованием архитектуры YOLO. Проект решает актуальную экологическую задачу раннего предупреждения для минимизации ущерба лесным экосистемам.
